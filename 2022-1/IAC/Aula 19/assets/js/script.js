...
//5a1
  ...
  //num=2592 || resto=0  || dividendo=2592  || resultado=0  || i=1
  function decimalToBases(num,base) {
      ...
      while (i == 0) {
          ...
          resultado += (base===16 && ehParaConverter(resto) ? decimalToHexa(resto) : resto);
  
          if(dividendo < base ){
              i++;
              resultado += (base===16 && ehParaConverter(dividendo) ? decimalToHexa(dividendo) : dividendo);
          } 
